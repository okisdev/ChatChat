            ...
            <div className='flex flex-row items-center space-x-3'>
                <div className='space-y-2'>
                    <div className='flex items-center space-x-2 text-sm'>
                        ...
                        {enableShare && (
                            <button className='inline-flex items-center space-x-1 rounded p-1 transition duration-200 ease-in-out hover:bg-gray-200 dark:hover:bg-stone-700' onClick={onCopy}>
                                <IoCopy />
                            </button>
                        )}
                    </div>

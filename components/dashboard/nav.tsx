            ...
            <div className='flex items-center justify-between'>
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Avatar className='inline-flex items-center justify-center space-x-1 rounded-lg p-1 transition duration-200 ease-in-out hover:bg-gray-200 dark:hover:bg-stone-700'>

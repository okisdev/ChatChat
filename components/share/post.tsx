...
const SharePost = ({ share }: ShareProps) => {
    ...
    return (
        <div className='m-1 flex w-full flex-grow flex-col space-y-3 rounded-lg bg-white/90 p-3 py-2 shadow backdrop-blur transition-transform duration-500 dark:bg-gray-800 md:m-3 md:space-y-10 md:p-6 md:px-4'>
            <div className='my-3 flex justify-between'>
                <div className='space-y-3'>
                    <p className='gradient-flow bg-gradient-to-r bg-clip-text text-2xl font-semibold leading-none text-transparent'>{siteConfig.title} Share</p>
                </div>
                <div>
                    <button className='inline-flex items-center space-x-1 rounded p-1 px-1 transition duration-200 ease-in-out hover:bg-gray-200' onClick={() => onCopyLink()}>

...
import LandingSide from '@/components/home/side';
...
const LandingHeader = () => {
    ...
    return (
        <div className='m-2 flex grow flex-col rounded-lg  bg-white/90 px-4 py-2 shadow backdrop-blur transition-transform duration-500 dark:bg-[#202327] md:p-3'>
                ...
                <div className='block md:hidden'>
                    <Sheet>
                        <SheetTrigger asChild>
                            <button className='inline-flex items-center space-x-1 rounded p-1 transition duration-200 ease-in-out hover:bg-gray-200 dark:hover:bg-stone-700'>
                                <FiLayout />
                            </button>
                        </SheetTrigger>
